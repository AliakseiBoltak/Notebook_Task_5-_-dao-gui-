 ...
 */
public class UnBlockFrame extends JFrame {
	...
	private void action() {
		...
		bBlock.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (userService.unBlockUser((tfUser.getText()))) {
						JOptionPane.showMessageDialog(panel, "User ¹ " + tfUser.getText() + " is unblocked", "Message",
